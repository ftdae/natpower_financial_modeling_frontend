...
export function TabThree(onClickTab: any) {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark" style={{
      padding: "20px"
    }}>
