...
export function calcTradeCreditorsForBalanceSheet({
  ...
  const trade_creditors = calcTradeCreditors({
    working_capital,
    vat,
    corporationTax,
    landRent,
    ...
    opexSensitivity,
    vintage,
  }).trade_creditors_for_balance_sheet;
  return roundArray(trade_creditors, 20);
}
