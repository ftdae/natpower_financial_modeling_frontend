...
const AggregatedProjectValuationTable = ({
  dashboardStyle = true,
  ...
  if (currentProjectType == 'bess') {
    ...
    const aggregated_valuation_results = emarineCalculationResults?.aggregation_valuation_results
...
export default AggregatedProjectValuationTable;
