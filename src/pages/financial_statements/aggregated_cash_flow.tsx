...
import { useAggregatedCashFlowData } from "../../hooks/tables/useAggregatedCashFlowData";

export function AggregatedCashFlow() {
  ...
  const {
    ...
    setDateRange,
  } = useAggregatedCashFlowData(active, hasTotal);
