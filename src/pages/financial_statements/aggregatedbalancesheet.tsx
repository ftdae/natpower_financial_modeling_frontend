...
import { useBalanceSheetData } from "../../hooks/tables/useBalanceSheetData";
import { useAggregatedBalanceSheetData } from "../../hooks/tables/useAggregatedBalanceSheetData";

export function AggregatedBalanceSheet() {
  ...
  const {
    ...
    setDateRange,
  } = useAggregatedBalanceSheetData(active, hasTotal);
  return (
