...
import { useAggregatedProfitLossData } from "../../hooks/tables/useAggregatedProfitAndLossData";

export function AggregatedProfitLoss() {
  ...
  const {
    ...
    setDateRange,
  } = useAggregatedProfitLossData(active, hasTotal);
    ...
    <div className="w-full  flex justify-center items-center rounded-lg mb-10">
      ...
      >
        ...
        <div className="px-5 pb-10">
          ...
          >
            Aggregated Profit and Loss Account (£)
          </div>
