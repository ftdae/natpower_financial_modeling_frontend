...
// const EmarineLastYearFinancialsTable = ({
//   dashboardStyle = true,
...
//   const last_year_financials = emarineCalculationResults?.current_project?.last_year_financials
//   let resultArray = [last_year_financials];
...
//                       {redNumber(roundNumber(dd?.last_year_revenue || 0, 0))}
//                     </td>
//                     <td className="border border-gray-300 text-center px-4 py-2">
//                       {redNumber(roundNumber(dd?.last_year_opex || 0, 2))}
//                     </td>
//                     <td className="border border-gray-300 text-center px-4 py-2">
//                       {redNumber(roundNumber(dd?.opex_percentage_to_revenue * 100 || 0, 2))}
//                     </td>
//                     <td className="border border-gray-300 text-center px-4 py-2">
//                       {redNumber(roundNumber(dd?.total_capex || 0, 2))}
//                     </td>
//                     <td className="border border-gray-300 text-center px-4 py-2">
...
// export default EmarineLastYearFinancialsTable;
