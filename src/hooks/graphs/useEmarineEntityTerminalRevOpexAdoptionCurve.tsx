...
export function useEmarineEntityTerminalRevOpexAdoptionCurve(active: string) {
    ...
    const chartData = useMemo(() => {
        const directData = emarineCalculationResults?.current_project?.entity_terminal_rev_opex_adoption_curves_graph_data
        const revenue =
            directData?.revenue
        const opex =
            directData?.opex

        const ciAdoptionCurve = directData?.ci_adoption_curve
        const propulAdoptionCurve = directData?.propul_adoption_curve

        const resultForQuarter = [
            {
                name: "Revenue" as string,
                data: (revenue || new Array(100).fill(0))
            ...
            {
                name: "Opex" as string,
                data: (opex || new Array(100).fill(0))
                    .concat(new Array(20).fill(0))
                    .map((r, index) => [
                        moment(modelStartDate)
                            .add(index, "quarters")
            ...
            {
                name: "Adoption curve - cold-ironing" as string,
                data: (ciAdoptionCurve || new Array(100).fill(0))
                    .concat(new Array(20).fill(0))
                    .map((r, index) => [
                        moment(modelStartDate)
                            .add(index, "quarters")
            ...
            {
                name: "Adoption curve - propulsion" as string,
                data: (propulAdoptionCurve || new Array(100).fill(0))
                    .concat(new Array(20).fill(0))
                    .map((r, index) => [
                        moment(modelStartDate)
                            .add(index, "quarters")
        ...
        const resultForAnnual = [
            ...
            },
            {
                name: "Adoption curve - cold-ironing" as string,
                data: getFilterData(
                    ciAdoptionCurve || new Array(100).fill(0),
                    modelStartDate,
                    active,
                    dateRange
                )
            ...
            },
            {
                name: "Adoption curve - propulsion" as string,
                data: getFilterData(
                    propulAdoptionCurve || new Array(100).fill(0),
                    modelStartDate,
                    active,
                    dateRange
                )
