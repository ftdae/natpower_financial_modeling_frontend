...
export function useBalanceSheetData(active: string, hasTotal: string) {
  ...
  const emarineTableData = useMemo(() => {
    ...
    const balancesheetResult =
      emarineCalculationResults?.current_project?.balance_sheet_results;
    console.log("balancesheetResult", balancesheetResult);
    const rlt = {
      id: "balance_sheet",
      title: "Balance Sheet",
      data: [],
